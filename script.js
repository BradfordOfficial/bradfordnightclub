...
function runUltimateAnalysis() {
    ...
    let approved = true;
    if (t === 'ban' || b === 'ban' || s === 'ban') approved = false;
    
    // Base de données de mots-clés colossale (Marques + Matières)
    const bad = [
  "short", "shorts", "bermuda", "jogging", "survetement", "legging",
  "nike", "adidas", "puma", "reebok", "under armour",
  "casquette", "snapback", "bonnet", "beanie",
  "hoodie", "sweat", "sweatshirt",
  "tong", "tongs", "claquette", "claquettes", "slides",
  "sandales sport", "crocs",
  "tee-shirt large", "oversize cheap", "debardeur",
  "tank top", "marcel",
  "jean troue", "jean dechire", "distressed",
  "baggy", "pantalon large street",
  "cargo large", "cargo militaire",
  "basket running", "chaussures sport",
  "air force", "air max", "yeezy",
  "new balance", "asics",
  "chaussettes apparentes", "chaussettes blanches",
  "flip flop",
  "polo cheap", "contrefacon",
  "logo XXL", "gros logo",
  "imprime cartoon", "print manga",
  "fluo", "flashy", "jaune fluo", "vert fluo",
  "ensemble sport",
  "veste de sport",
  "doudoune", "anorak",
  "kway",
  ...
  "tenue plage",
  "maillot",
  "chemise ouverte torse nu",
  "marques fast fashion",
  "shein", "zara", "h&m", "primark",
  "imitation cuir",
  "faux daim",
  "imprime animal excessif",
  "tiger print",
  "leopard cheap",
  "camouflage",
  "workwear sale",
  ...
  "mitaines",
  "tenue bricolage",
  "tenue sport collective"
];
    const good = [
  "prada", "saint laurent", "ysl", "celine", "margiela",
  "loewe", "balenciaga", "givenchy",
  "tom ford", "brioni", "kiton", "zegna",
  "gucci", "hermes", "dior", "valentino",
  ...
  "dress code respected"
    ...
    bad.forEach(w => { if(text.includes(w)) approved = false; });
